...
def menuSystem():
    try:
        print("Welcome to EzNMAP... NMAP the simple way")
        ...
        print("[11]: Exit")
        NmapScanSelection = int(raw_input("Please select an option: "))
        if NmapScanSelection == 1:
            ...
            print("You have chosen: NSE Scripts")
            print("***STARTING***")
            nseScripts()
...
def targetSpecification():
    ...
    print("[9]: Go back")
    targetSpecificationSelection = int(raw_input("Please select an option between: "))
...
def scanTechniques():
    ...
    print("[7]: Go back")
    scanTechniquesSelection = int(raw_input("Please make a selection: "))
...
def hostDiscovery():
    ...
    print("[9]: Go back")
    hostDiscoverySelection = int(raw_input("Please make a selection: "))
...
def portSpecification():
    ...
    print("[10]: Go back")
    portSpecificationSelection = int(raw_input("Please make a selection: "))
...
def serviceAndVersionDetection():
    ...
    print("[10]: Go back")
    serviceAndVersionDetectionSelection = int(raw_input("Please make a selection: "))
...
def timingAndPerformance():
    ...
    print("[7]: Go back")
    timingAndPerformanceSelection = int(raw_input("Please make a selection: "))
...
def nseScripts():
    ...
    print("[14]: Go back")
    nseScriptsSelection = int(raw_input("Please make a selection: "))
...
def firewallIdsEvasionAndSpoofing():
    ...
    print("[9]: Go back")
    fireEvasion = int(raw_input("Please make a selection:"))
    if fireEvasion == 1:
...
def NMAPoutput():
    ...
    print("[17]: Go back")
    outputChoice = int(raw_input("Please make a selection: "))
    if outputChoice == 1:
...
def otherUsefulNmapCommands():
    ...
    print("[4]: Go back")
    otherUsefulSelection = int(raw_input("Please make a selection: "))
